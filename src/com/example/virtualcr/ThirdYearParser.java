...
public class ThirdYearParser extends AsyncTask<String, String, String> {

	JSONParser jParser = new JSONParser();
	// url to get all products list
	private static String url = "http://192.168.43.8/connect/ipg3.php";	// JSON Node names, 2 for counter, add data
	...
	String output;
	int i = 0;
	public ThirdYearParser(Context parent,String output) {
