...
public class FirstYearParser extends AsyncTask<String, String, String> {

	JSONParser jParser = new JSONParser();
	// url to get all products list
	private static String url = "http://192.168.43.65/connect/ipg1.php";	// JSON Node names, 2 for counter, add data
	...
	String output;
	int i = 0;
	public FirstYearParser(){}
	public FirstYearParser(Context parent,String output) {
