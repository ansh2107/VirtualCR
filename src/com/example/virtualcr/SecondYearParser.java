...
public class SecondYearParser extends AsyncTask<String, String, String> {

	JSONParser jParser = new JSONParser();
	// url to get all products list
	private static String url = "http://192.168.43.8/connect/ipg2.php";	// JSON Node names, 2 for counter, add data
	...
	String output;
	int i = 0;
	public SecondYearParser(Context parent,String output) {
